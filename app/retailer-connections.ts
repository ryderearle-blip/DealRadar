...
export function buildRetailerStatuses(bestBuyConfigured: boolean): RetailerStatus[] {
  return [
    ...
    },
    {
      ...
      health: 'action_required',
      capability: 'partner-prices',
      message: 'Marketplace partner approval required before price results can be enabled',
      requirement: 'Approved Walmart Marketplace integration and OAuth credentials',
